...
class Viewer(object):
    def __init__(self, width, height, display=None):
        """Initialize a viewer with fixed height and width, where the height * width indicates the number of grid
        """
    ...
    def add_red_geom(self, geom):
        self.red_geoms.append(geom)
    ...
    def draw_react(self, left_top, width, height, filled=True):
        pass
